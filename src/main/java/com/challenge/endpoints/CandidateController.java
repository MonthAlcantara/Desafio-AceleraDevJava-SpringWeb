...
public class CandidateController {
    ...
    public ResponseEntity<?> findCandidateByUserIdAndCompanyIdAndAccelerationId(@PathVariable("UserId") Long userId,
    ...
    @GetMapping
    public ResponseEntity<?> findByCompanyIdOrAccelerationId(@RequestParam(value = "companyId", required = false) Optional<Long> companyId,
